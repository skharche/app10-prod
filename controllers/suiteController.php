...
if (isset($_REQUEST["param"])) {
	...
	switch ($_REQUEST["param"]) {
		...
		case "getAvailableOfficeSpaceDetails":
			...
			echo json_encode(array("status" => "success", "summaryDetails" => $marketData[0], "data" => $marketData[1], "suiteOtherImages" => $marketData[2], "totalOfficeArea" => $marketData[3], "lastRecordDate" => $marketData[4], "companySummary" => $marketData[5]));
			break;
		default:
